odoo.define('st_facturacion_computarizada_bolivia_v13.action_manager_fact', function (require) {
"use strict";
...
ActionManager.include({
    ...
    _handleAction: function (action, options) {
        ...
        if (action.type === 'ir_actions_xlsx_download_libro') {
