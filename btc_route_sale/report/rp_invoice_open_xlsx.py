...
class RpPaymentSaleBleichnerXlsx(models.AbstractModel):
    _name = "report.report_xlsx.rp_invoice_open_xlsx"
    _inherit = "report.report_xlsx.abstract"
    _description = "Open invoice XLSX Report"
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        report_title = "Reporte de Cuentas por Cobrar"

        sheet = workbook.add_worksheet('Detalle de Cuentas por Cobrar')
        ...
        sheet.write(4, 7, 'TOTAL VENTAS', titulo2)
        ...
        domain_line += [('move_id.is_account_receivable', '=', True)]
        domain_line += [('debit', '>', 0.0)]
        if branch_id:
        ...
        for rec in obj_account_due:
            ...
            total_paid = sum(rec.credit for rec in partial_reconcile_ids.credit_move_id)
            total_due = rec.debit - total_paid
            if total_due > 0.01:
                amount_total += rec.debit
                ...
                sheet.write(filas, 7, rec.debit, number_right)
