...
import base64
class SdStockPickingRecepcionConsignacion1(models.Model):
    ...
    def getporcentaje(self):
        # print('porcentaje: ' + self.sd_porcentaje)
        porcentaje = self.sd_porcentaje

        if not self.sd_porcentaje:
            porcentaje = ''
